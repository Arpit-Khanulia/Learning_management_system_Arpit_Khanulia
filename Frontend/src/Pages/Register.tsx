  ...
  return (
    <section className="h-screen flex flex-col md:flex-row justify-center space-y-10 md:space-y-0 md:space-x-16 items-center my-2 mx-5 md:mx-0 md:my-0">
      <div className="md:w-1/3 max-w-sm">
        <img
          src="https://www.ianbrodie.com/wp-content/uploads/2021/01/online-courses.png"
          alt="Sample image" />
      </div>
      <div className="md:w-1/3 max-w-sm">
        ...
        <form onSubmit={handleSubmit} >
            ...
            <select className="dropdown dropdown-right dropdown-end btn mt-2"  name="role" value={values.role}  onChange={handleChange} onBlur={handleBlur} >Role
                    <option  >Role </option>
